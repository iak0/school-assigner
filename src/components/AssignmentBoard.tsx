...
export const AssignmentBoard: React.FC<AssignmentBoardProps> = ({
  ...
  const getLetterBadge = (score: number) => {
    ...
    return (
      <span
        ...
        title={`Application letter score modifier: ${score > 0 ? `+${score}` : score}`}
      >
        {score > 0 ? `+${score}` : score}
      </span>
    );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white rounded-2xl px-5 py-4 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            disabled={isGenerating || roles.length === 0 || students.length === 0}
          ...
          >
            ...
            {isGenerating ? 'Matching...' : '✨ Generate Optimal Matches'}
          </button>
        </div>
      </div>

      {/* Main Grid + Sidebar Split Pane */}
                      ...
                      >
                        <div className="flex items-center justify-between gap-1.5 pointer-events-none">
                          ...
                          <div className="flex items-center gap-1 flex-shrink-0">
                            ...
                            {getLetterBadge(assigned.letterScore)}
            ...
            <div className="p-3.5 bg-slate-50 border-b border-slate-200 pointer-events-none">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] bg-slate-200 text-slate-700 px-2 py-0.5 rounded-full font-bold">
                  {unassignedStudents.length} Pool
                </span>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between pointer-events-none">
                        ...
                        {getLetterBadge(unassigned.letterScore)}
                      </div>
